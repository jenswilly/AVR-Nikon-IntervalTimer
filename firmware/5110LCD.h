...
#define SET_DC_PIN                 PORTD |= _BV( PD3 );
#define CLEAR_DC_PIN               PORTD &= ~_BV( PD3 );

#define SET_SCE_PIN                PORTD |= _BV( PD2 );
#define CLEAR_SCE_PIN              PORTD &= ~_BV( PD2 );

#define SET_RST_PIN                PORTD |= _BV( PD7 );
#define CLEAR_RST_PIN              PORTD &= ~_BV( PD7 );
